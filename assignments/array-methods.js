...
const firstNamesAllCaps = runners.map(function(runner){
...
const runnersLargeSizeShirt = runners.filter(function(runner){
...
const ticketPriceTotal = runners.reduce(function(accum, runner){
...
// Problem 1
// Return all runners with emails on a .edu domain to give student's special T-shirt
let eduEmails = runners.filter(function(runner){
...
// Problem 2
// Return a list of all companies involved in the run
let companyNames = [];
runners.forEach(function(element){
...
// Problem 3
// Filter this list of company names to remove duplicates

var noDuplicates = companyNames.filter( function(company, index, inputArray ) {
  return inputArray.indexOf(company) == index;
